...
formDOM.addEventListener('submit', async (e) => {
  ...
  try {
    if (submitDOM.value == 'Ajouter une salle') {
      ...
      await axios.patch(`/api/salles/${id}`, {
        nom: nom,
        type: type,
        bloc: bloc,
      })
      ...
      .map((salle) => {
        ...
        return `
          <tr>
              ...
              <td>
              <button type="button" class="btnu btn btn-secondary" data-blocid="${bloc._id}" data-bloc="${bloc.nom}" data-type="${type}" data-nom="${nom}" data-id="${salleID}">
              <i>modifier</i>
              </button>
              </td>
              <td>
              <button type="button" class="btnd btn btn-danger" data-id="${salleID}">
              <i>supprimer</i>
              </button>
              </td>
            </tr>
