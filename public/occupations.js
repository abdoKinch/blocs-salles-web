      ...
      .map((occupation) => {
        ...
        return `
          <tr>
              ...
              <td>
              <button type="button" class="btnu btn btn-secondary"data-id="${occupationID}" data-salleid="${salle._id}" data-creneauid="${creneau._id}">
              <i>modifier</i>
              </button>
              </td>
              <td>
              <button type="button" class="btnd btn btn-danger" data-id="${occupationID}">
              <i>supprimer</i>
              </button>
              </td>
            </tr>
